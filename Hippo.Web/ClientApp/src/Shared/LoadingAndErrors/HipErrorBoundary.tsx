...
interface HipErrorBoundaryProps {
  children: React.ReactNode;
  fallback?: React.ReactNode;
}

interface HipErrorBoundaryState {
  hasError: boolean;
}
 ...
 */
class HipErrorBoundary extends React.Component<
  HipErrorBoundaryProps,
  HipErrorBoundaryState
> {
  constructor(props: HipErrorBoundaryProps) {
    super(props);
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    ...
    //   in HipErrorBoundary (created by App)
...
export default HipErrorBoundary;
