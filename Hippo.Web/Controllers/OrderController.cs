...
namespace Hippo.Web.Controllers
{
    ...
    public class OrderController : SuperController
    {
        ...
        public async Task<IActionResult> AdminOrders()
        {
            ...
            var adminStatuses = new List<string> {Order.Statuses.Created, Order.Statuses.Submitted, Order.Statuses.Processing, Order.Statuses.Active, Order.Statuses.Closed, Order.Statuses.Completed };
        ...
        public async Task<IActionResult> ChangeStatus(int id, string expectedStatus)
        {
            ...
            switch (existingOrder.Status)
            {
                ...
                case Order.Statuses.Closed:
                    ...
                    //Think we want to allow a closed order to be archived.
                    ...
                    {
                        return BadRequest("Expiration date must be in the past to archive a non-recurring order.");
                    }
